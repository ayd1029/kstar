<template>
  <q-page class="page-default">
    ...
    <div class="row q-pl-md row justify-center q-pt-sm q-pb-sm">
      <div class="col-12">
        {{ $t('menu_nft_project_list_description') }}
      </div>
    </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    selectListMax() {
      ...
      this.$axios.get('/api/nft/selectNftProjectListLastPageNum',
    ...
    selectList(idx, done) {
      ...
      this.$axios.get('/api/nft/selectNftProjectList',
