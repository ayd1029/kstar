  ...
  <q-page class="q-pa-md page-default">
    <div class="row justify-center">
      <div class="col-12 doc-heading doc-h2">
        {{ $t('menu_whitelist_modify') }}
      </div>
    </div>
    <q-separator />
    <div class="row justify-center q-pt-sm q-pb-sm">
      <div class="col-12">
        {{ $t('menu_whitelist_modify_description') }}
      </div>
    </div>
    ...
    <div class="row justify-center q-pt-xl">
      ...
      <div class="col-6 text-right">
        <q-btn class="btn" color="secondary" text-color="black" size="lg" style="width: 98%;" @click="modifyWhitelist" tabindex="20">
          <b>{{ $t('modify') }}</b>
        </q-btn>
      </div>
    </div>
  ...
  methods: {
    ...
    async selectWhitelist() {
      ...
      if (result.data) {
        ...
        this.same_score_type = result.data.same_score_type,
    ...
    modifyWhitelist() {
      ...
      this.$axios.post('/api/whitelist/updateWhitelist', param)
        .then((result) => {
