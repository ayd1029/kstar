  ...
  <q-page class="q-pa-md page-default">
    <div class="row justify-center">
      <div class="col-12 doc-heading doc-h2">
        {{ $t('menu_minting_modify') }}
      </div>
    </div>
    <q-separator />
    <div class="row justify-center q-pt-sm q-pb-sm">
      <div class="col-12">
        {{ $t('menu_minting_modify_description') }}
      </div>
    </div>
    ...
    <div class="row justify-center q-pt-xl">
      ...
      <div class="col-6 text-right">
        <q-btn class="btn" color="secondary" text-color="black" size="lg" style="width: 98%;" @click="modifyMinting" tabindex="11">
          <b>{{ $t('modify') }}</b>
        </q-btn>
      </div>
    </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    modifyMinting() {
      ...
      this.$axios.post('/api/minting/updateMinting', param)
        .then((result) => {
