  ...
  <q-page class="q-pa-md page-default">
    <div class="row justify-center">
      <div class="col-12 doc-heading doc-h2">
        {{ $t('menu_recruit_register') }}
      </div>
    </div>
    <q-separator />
    <div class="row justify-center q-pt-sm q-pb-sm">
      <div class="col-12">
        {{ $t('menu_recruit_register_description') }}
      </div>
    </div>
    ...
    <div class="row justify-center q-pt-xl">
      ...
      <div class="col-6 text-right">
        <q-btn class="btn" color="secondary" text-color="black" size="lg" style="width: 98%;" @click="registerRecruit" tabindex="20">
          <b>{{ $t('register') }}</b>
        </q-btn>
      </div>
    </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    registerRecruit() {
      ...
      this.$axios.post('/api/recruit/insertRecruit', param)
        .then((result) => {
