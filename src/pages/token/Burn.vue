  ...
  methods: {
    burnToken() {
      ...
      this.$q.loading.show({
        ...
        message: this.$t('loading_message_burn_token'),
      })
      ...
      this.$axios.post('/api/tokenburn/checkTokenBurnStatusCdPaid', params)
        .then((result) => {
    ...
    doBurnToken() {
      ...
      this.$axios.post('/api/tokenburn/burn', params)
        .then((result) => {
          // console.log(JSON.stringify(result.data))
          if (result.data && result.data.resultCd === 'SUCCESS') {
