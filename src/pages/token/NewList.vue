<template>
  <q-page class="page-default">
    ...
    <div class="row q-pl-md row justify-center q-pt-sm q-pb-sm">
      <div class="col-12">
        {{ $t('menu_new_token_list_description') }}
      </div>
    </div>
    ...
    <q-pull-to-refresh @refresh="refresher">
      <q-infinite-scroll @load="loadMore" :offset="0" ref="infiniteScroll">
        ...
        <div v-for="item in tokenList" :key="item.seq" style="cursor: pointer;z-index: 1;">
          <q-separator />
          <q-item clickable @click="showDetail(item.seq)">
...
export default defineComponent({
  ...
  methods: {
    ...
    selectListMax() {
      ...
      this.$axios.get('/api/token/selectNewTokenListLastPageNum',
    ...
    selectList(idx, done) {
      ...
      this.$axios.get('/api/token/selectNewTokenList',
